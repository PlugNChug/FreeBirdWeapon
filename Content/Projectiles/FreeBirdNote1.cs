...
{
    public class FreeBirdNote1 : ModProjectile
    {
        ...
        public NPC FindClosestNPC(float maxDetectDistance)
        {
            ...
            {
                if (target.CanBeChasedBy(this, ignoreDontTakeDamage: true) && !target.dontTakeDamage && Collision.CanHitLine(Projectile.Center, Projectile.width, Projectile.height, target.position, target.width, target.height))
                {
